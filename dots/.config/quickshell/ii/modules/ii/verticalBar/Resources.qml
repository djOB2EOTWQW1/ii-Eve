...
MouseArea {
    ...
    readonly property int catWidth: Appearance.sizes.verticalBarWidth
    readonly property int catHeight: Math.round(catWidth / 1.30)
    ...
    component ResourceWithDot: ColumnLayout {
        id: wrap
        spacing: 0
